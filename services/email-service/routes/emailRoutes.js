...
router.put("/settings", requireInternalToken, async (req, res) => {
  ...
  const next = {
    ...
    allowedTemplatesByCategory: body.allowedTemplatesByCategory || existing.allowedTemplatesByCategory,
    disabledTemplates: body.disabledTemplates || existing.disabledTemplates,
